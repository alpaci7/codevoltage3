                        ...
                        <div className="form-children">
                                <div className="google-auth">
                                    ...
                                    <Button className="google-button" 
                                         ...
                                         onClick={()=>{
                                            window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?response_type=code&redirect_uri=http://localhost:3000/auth/google/redirect&scope=profile+email&client_id=${process.env.REACT_APP_GOOGLE_CLIENT_ID}`;
                ...
                :
                    <div className="form">
                        ...
                        <Form onSubmit={handleSignup}>
                            ...
                            <div className="form-buttons">
                                <Button type="submit" $BorderRadius="5px">{t('Sign Up')}</Button>
